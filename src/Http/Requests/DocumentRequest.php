...
namespace Litecms\Document\Http\Requests;
...
class DocumentRequest extends FormRequest
{
    ...
    {
        $this->model = $this->route('document');

        if (is_null($this->model)) {
            // Determine if the user is authorized to access document module,
    ...
    {
        return user()->canDo('document.document.view');
    }
}
