<div class="btn-group document-document">
...
$(document).ready(function(){
    ...
    $(".document-document .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/document.document.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".document-document .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.document-document .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'document.document.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#document-document-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#document-document-list .btn-reset-filter').css('display', 'none');
